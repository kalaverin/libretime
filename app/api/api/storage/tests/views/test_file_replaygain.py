...
class TestReplayGainStorage:
    ...
    def test_positive_replay_gain(self, api_client):
    ...
    def test_zero_replay_gain(self, api_client):
    ...
    def test_null_replay_gain(self, api_client):
    ...
    def test_high_precision_replay_gain(self, api_client):
...
class TestReplayGainUpdate:
    ...
    def test_update_replay_gain(self, api_client):
    ...
    def test_clear_replay_gain(self, api_client):
...
class TestReplayGainInList:
    ...
    def test_list_includes_replay_gain(self, api_client):
    ...
    def test_list_shows_null_replay_gain(self, api_client):
...
class TestReplayGainFiltering:
    ...
    def test_filter_files_with_replay_gain(self, api_client):
...
class TestReplayGainEdgeCases:
    ...
    def test_very_large_negative_replay_gain(self, api_client):
    ...
    def test_very_large_positive_replay_gain(self, api_client):
    ...
    def test_replay_gain_with_trailing_zeros(self, api_client):
