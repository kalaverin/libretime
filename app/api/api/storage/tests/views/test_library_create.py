...
class TestLibraryViewSetCreate:
    ...
    def test_create_library_success(self, api_client):
    ...
    def test_create_library_returns_json(self, api_client):
    ...
    def test_create_library_minimal_data(self, api_client):
    ...
    def test_create_library_missing_code_fails(self, api_client):
    ...
    def test_create_library_missing_name_db_error(self, api_client):
    ...
    def test_create_library_missing_description_db_error(self, api_client):
    ...
    def test_create_library_empty_description_fails(self, api_client):
    ...
    def test_create_library_code_unique_fails(self, api_client):
    ...
    def test_create_library_long_code_fails(self, api_client):
    ...
    def test_create_library_long_name_succeeds(self, api_client):
    ...
    def test_create_library_name_too_long_fails(self, api_client):
    ...
    def test_create_library_unicode_in_code_fails(self, api_client):
    ...
    def test_create_library_unicode_in_name_succeeds(self, api_client):
    ...
    def test_create_library_enabled_defaults_to_true(self, api_client):
    ...
    def test_create_library_explicit_enabled(self, api_client):
    ...
    def test_create_library_analyze_cue_points_defaults(self, api_client):
    ...
    def test_create_library_explicit_analyze_cue_points(self, api_client):
    ...
    def test_create_library_generates_id(self, api_client):
    ...
    def test_create_library_special_chars_in_name_succeeds(self, api_client):
