...
class TestFileViewSetUpdate:
    ...
    def test_patch_update_metadata_success(self, api_client):
    ...
    def test_patch_update_genre(self, api_client):
    ...
    def test_patch_clear_nullable_field(self, api_client):
    ...
    def test_patch_update_library(self, api_client):
