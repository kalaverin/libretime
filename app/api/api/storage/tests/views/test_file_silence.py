...
class TestFileForSilenceProcessing:
    ...
    def test_success_file_ready_for_processing(self, api_client):
    ...
    def test_pending_file_not_ready(self, api_client):
    ...
    def test_failed_file_not_processed(self, api_client):
...
class TestAudioFileProperties:
    ...
    def test_audio_file_channels(self, api_client):
    ...
    def test_audio_file_length(self, api_client):
    ...
    def test_mono_audio_file(self, api_client):
...
class TestSilenceDetectionEdgeCases:
    ...
    def test_very_short_file(self, api_client):
    ...
    def test_very_long_file(self, api_client):
    ...
    def test_various_mime_types(self, api_client):
...
class TestFileListForProcessing:
    ...
    def test_list_success_files(self, api_client):
