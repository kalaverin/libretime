...
class TestFileViewSetValidation:
    ...
    def test_create_missing_mime_fails(self, api_client):
    ...
    def test_create_missing_size_fails(self, api_client):
    ...
    def test_create_missing_accessed_fails(self, api_client):
    ...
    def test_create_empty_name_fails(self, api_client):
    ...
    def test_create_long_name_succeeds(self, api_client):
    ...
    def test_create_name_too_long_fails(self, api_client):
    ...
    def test_create_negative_size_fails(self, api_client):
    ...
    def test_create_zero_size_succeeds(self, api_client):
    ...
    def test_create_large_size_fails(self, api_client):
    ...
    def test_create_invalid_mime_format_succeeds(self, api_client):
    ...
    def test_create_empty_mime_fails(self, api_client):
    ...
    def test_create_unicode_in_name_succeeds(self, api_client):
    ...
    def test_create_special_chars_in_name_succeeds(self, api_client):
    ...
    def test_create_invalid_import_status_fails(self, api_client):
    ...
    def test_create_null_required_field_fails(self, api_client):
    ...
    def test_create_extra_fields_ignored(self, api_client):
    ...
    def test_create_duplicate_filepath_succeeds(self, api_client):
    ...
    def test_create_invalid_json_fails(self, api_client):
    ...
    def test_create_empty_body_fails(self, api_client):
    ...
    def test_update_invalid_mime_succeeds(self, api_client):
