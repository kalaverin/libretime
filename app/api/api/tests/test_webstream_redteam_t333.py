...
class TestWebstreamIDOR:
    ...
    def test_list_webstreams_shows_only_own(self, api_client, admin_user, regular_user):
    ...
    def test_access_other_user_webstream(self, api_client, admin_user, regular_user):
    ...
    def test_modify_other_user_webstream(self, api_client, admin_user, regular_user):
...
class TestWebstreamSQLInjection:
    ...
    def test_sqli_in_url_field(self, api_client, admin_user):
        ...
        response = api_client.post(
            "/api/v2/webstreams",
            {"name": "Test Stream", "url": "http://test.com'; DROP TABLE cc_webstream;--"},
            format="json"
        )
...
class TestWebstreamOwnerBypass:
    ...
    def test_create_webstream_with_other_owner(self, api_client, admin_user, regular_user):
    ...
    def test_change_webstream_owner(self, api_client, admin_user, regular_user):
    ...
    def test_create_webstream_without_auth(self, api_client):
        ...
        try:
            response = api_client.post(
                "/api/v2/webstreams",
                {"name": "Anonymous Stream", "url": "http://anon.com/stream", "description": "test"},
                format="json"
            )
            # If we get here, should be 403 or 400
            assert response.status_code in [403, 400, 500]  # 500 if IntegrityError not handled
...
class TestWebstreamFieldValidation:
    ...
    def test_unicode_in_name(self, api_client, admin_user):
        ...
        response = api_client.post(
            "/api/v2/webstreams",
            {"name": "日本語 🎉 Émojis", "url": "http://test.com/stream", "description": "test"},
            format="json"
        )
...
class TestWebstreamDelete:
    ...
    def test_delete_other_user_webstream(self, api_client, admin_user, regular_user):
