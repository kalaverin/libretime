...
class TestShowAnonymousCreate:
    ...
    def test_anonymous_create_show_with_extra_fields_blocked(self, anonymous_client):
...
class TestShowAnonymousUpdate:
    ...
    def test_anonymous_patch_show_blocked(self, anonymous_client):
        ...
        assert show.name == "Original Name", "T384: Show was modified despite blocked request"
...
class TestShowAnonymousDelete:
    ...
    def test_anonymous_delete_show_blocked(self, anonymous_client):
        ...
        assert Show.objects.filter(id=show_id).exists(), "T387: Show was deleted despite blocked request"
    ...
    def test_anonymous_delete_all_shows_blocked(self, anonymous_client):
        ...
        for show_id in show_ids:
            assert Show.objects.filter(id=show_id).exists(), f"T387: Show {show_id} was deleted"
