...
class TestFixturesPrivilegeEscalation:
    ...
    def test_cannot_escalate_via_user_update(self, regular_user, api_client):
...
class TestFixturesDataIsolation:
    ...
    def test_api_key_sees_all_data(self, api_client, regular_user):
        ...
        if response1.status_code == 201:
            ...
            response2 = api_client.get(f"/api/v2/playlists/{playlist_id}")
...
class TestFixturesMassAssignment:
    ...
    def test_cannot_mass_assign_is_superuser(self, api_client):
