...
class TestAnonymousAccessDenied:
    ...
    @pytest.mark.parametrize("endpoint,name", ALL_GET_ENDPOINTS)
    def test_anonymous_post_returns_403(
        self, anonymous_client, endpoint, name,
    ):
    ...
    @pytest.mark.parametrize("endpoint,name", ALL_GET_ENDPOINTS)
    def test_anonymous_patch_returns_403(
        self, anonymous_client, endpoint, name,
    ):
    ...
    @pytest.mark.parametrize("endpoint,name", ALL_GET_ENDPOINTS)
    def test_anonymous_delete_returns_403(
        self, anonymous_client, endpoint, name,
    ):
...
class TestAnonymousWithInvalidAuthHeader:
    ...
    def test_anonymous_with_malformed_api_key_still_403(
