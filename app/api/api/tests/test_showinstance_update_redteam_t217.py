...
class TestShowInstanceUpdateAuthentication:
    ...
    def test_update_without_auth(self, api_client):
        ...
        assert response.status_code in [401, 403], "Anonymous can update show instances"
    ...
    def test_put_without_auth(self, api_client):
        ...
        assert response.status_code in [401, 403], "Anonymous can PUT show instances"
...
class TestShowInstanceUpdateBOLA:
    ...
    def test_update_other_user_instance(self, api_client, regular_user, admin_user):
        ...
        assert response.status_code in [403, 404], "Can update other user's instance (BOLA)"
        ...
        for payload in xss_payloads:
            ...
            if response.status_code == 200:
                ...
                if result.get("description") == payload:
                    pytest.fail(f"BUG: XSS payload stored unescaped: {payload[:30]}")
