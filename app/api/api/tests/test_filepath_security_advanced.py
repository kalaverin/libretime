...
class TestFilepathJunkCharacters:
    ...
    def test_control_characters_rejected(self, admin_user):
        ...
        control_chars = ['\x01', '\x08', '\x0b', '\x0c', '\x0e', '\x1f', '\x7f']
        ...
        for char in control_chars:
            ...
            assert response.status_code == 400, f"Control char {repr(char)} should be rejected"
    ...
    def test_zero_width_characters_rejected(self, admin_user):
        ...
        for char in zw_chars:
            ...
            assert response.status_code == 400, f"Zero-width char {repr(char)} should be rejected"
    ...
    def test_bidirectional_override_rejected(self, admin_user):
        ...
        for char in bidi_chars:
            ...
            assert response.status_code == 400, f"Bidi char {repr(char)} should be rejected"
...
class TestFilepathPathlibResolve:
    ...
    def test_destroy_with_traversal_blocked_by_pathlib(self, admin_user):
        ...
        assert response.status_code in [500, 204]  # 500 if blocked, 204 if file not found
