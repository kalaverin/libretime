...
class TestPlaylistPermissionsRedTeam:
    ...
    def test_bfla_admin_endpoints_user_access(self, api_client):
    ...
    def test_permission_elevation_host_to_admin(self, api_client):
    ...
    def test_permission_without_view_playlist(self, api_client):
    ...
    def test_cross_user_list_filtering(self, api_client):
    ...
    def test_http_parameter_pollution(self, api_client):
    ...
    def test_cache_poisoning_via_headers(self, api_client):
