...
class TestShowInstanceViewSetList:
    ...
    def test_list_instances_empty_returns_200(self, api_client):
        """LIST with no instances should return empty array."""
        response = api_client.get("/api/v2/show-instances")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_instances_returns_all(self, api_client):
    ...
    def test_list_instances_contains_id(self, api_client):
    ...
    def test_list_instances_contains_show(self, api_client):
    ...
    def test_list_instances_contains_starts_at(self, api_client):
    ...
    def test_list_instances_contains_ends_at(self, api_client):
    ...
    def test_list_instances_contains_filled_time(self, api_client):
    ...
    def test_list_instances_null_filled_time(self, api_client):
    ...
    def test_list_instances_contains_description(self, api_client):
    ...
    def test_list_instances_contains_modified(self, api_client):
    ...
    def test_list_instances_contains_rebroadcast(self, api_client):
    ...
    def test_list_instances_contains_auto_playlist_built(self, api_client):
    ...
    def test_list_instances_filter_by_show(self, api_client):
        ...
        response = api_client.get(f"/api/v2/show-instances?show={show1.id}")
