...
class TestShowDaysViewSetList:
    ...
    def test_list_show_days_empty_returns_200(self, api_client):
        """LIST with no show days should return empty array."""
        response = api_client.get("/api/v2/show-days")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_show_days_returns_all(self, api_client):
    ...
    def test_list_show_days_returns_json(self, api_client):
    ...
    def test_list_show_days_contains_id(self, api_client):
    ...
    def test_list_show_days_contains_show(self, api_client):
    ...
    def test_list_show_days_contains_first_show_on(self, api_client):
    ...
    def test_list_show_days_contains_last_show_on(self, api_client):
    ...
    def test_list_show_days_null_last_show_on(self, api_client):
    ...
    def test_list_show_days_contains_start_time(self, api_client):
    ...
    def test_list_show_days_contains_timezone(self, api_client):
    ...
    def test_list_show_days_contains_duration(self, api_client):
    ...
    def test_list_show_days_contains_week_day(self, api_client):
    ...
    def test_list_show_days_contains_repeat_kind(self, api_client):
    ...
    def test_list_show_days_contains_record_enabled(self, api_client):
    ...
    def test_list_show_days_contains_repeat_next_on(self, api_client):
    ...
    def test_list_show_days_filter_by_show(self, api_client):
        ...
        response = api_client.get(f"/api/v2/show-days?show={show1.id}")
        # Filtering may or may not be supported
        assert response.status_code in [200, 400]

    def test_list_show_days_multiple_days_same_show(self, api_client):
