...
class TestPlaylistContentViewSetUpdate:
    ...
    def test_patch_update_position_success(self, api_client):
    ...
    def test_patch_update_cue_points(self, api_client):
    ...
    def test_patch_update_offset(self, api_client):
    ...
    def test_patch_update_fade_times(self, api_client):
    ...
    def test_update_change_playlist(self, api_client):
    ...
    def test_update_change_content_kind(self, api_client):
