...
class TestScheduleUpdateRedTeam:
    ...
    def test_bopla_mass_assignment_id_update(self, api_client, faker):
    ...
    def test_ssrf_update_to_internal_stream(self, api_client, faker):
    ...
    @pytest.mark.xfail(reason="T597: Auth - Invalid token returns 200")
    def test_update_with_invalid_token(self, api_client, faker):
        ...
        try:
            ...
            if response.status_code == 200:
                pytest.fail("T597: Invalid token accepted")
            assert response.status_code == 403
        finally:
    ...
    def test_sqli_in_update_fields(self, api_client, faker):
    ...
    def test_nosql_injection_in_update(self, api_client, faker):
    ...
    def test_unicode_in_update_fields(self, api_client, faker):
    ...
    def test_race_condition_concurrent_update(self, api_client, faker):
