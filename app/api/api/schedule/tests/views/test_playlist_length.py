...
class TestPlaylistLengthField:
    ...
    def test_playlist_retrieve_contains_length(self, api_client):
    ...
    def test_playlist_list_contains_length(self, api_client):
    ...
    def test_playlist_create_accepts_length(self, api_client):
    ...
    def test_playlist_update_accepts_length(self, api_client):
    ...
    def test_playlist_null_length(self, api_client):
    ...
    def test_playlist_length_zero(self, api_client):
