...
class TestShowViewSetUpdate:
    ...
    def test_patch_update_genre_success(self, api_client):
    ...
    def test_patch_update_url_success(self, api_client):
    ...
    def test_patch_update_colors_success(self, api_client):
    ...
    def test_patch_update_linked_flags_success(self, api_client):
    ...
    def test_patch_update_auto_playlist_flags_success(self, api_client):
    ...
    def test_patch_update_intro_outro_flags_success(self, api_client):
    ...
    def test_update_name_too_long_fails(self, api_client):
