...
class TestPlaylistViewSetPermissions:
    ...
    def test_create_with_auth_returns_201(self, api_client):
    ...
    def test_user_can_view_other_users_playlists(self, api_client):
    ...
    def test_user_can_update_other_users_playlists(self, api_client):
    ...
    def test_user_can_delete_other_users_playlists(self, api_client):
