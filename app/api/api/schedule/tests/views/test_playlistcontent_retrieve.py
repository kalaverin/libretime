...
class TestPlaylistContentViewSetRetrieve:
    ...
    def test_retrieve_file_content_success(self, api_client):
    ...
    def test_retrieve_stream_content_success(self, api_client):
    ...
    def test_retrieve_block_content_success(self, api_client):
    ...
    def test_retrieve_returns_all_fields(self, api_client):
    ...
    def test_retrieve_id_zero_returns_404(self, api_client):
        """RETRIEVE with id=0 should return 404."""
        response = api_client.get("/api/v2/playlist-contents/0")
        assert response.status_code == 404

    def test_retrieve_negative_id_returns_404(self, api_client):
        """RETRIEVE with negative id should return 404."""
        response = api_client.get("/api/v2/playlist-contents/-1")
        assert response.status_code == 404

    def test_retrieve_sql_injection_attempt(self, api_client):
        """RETRIEVE with SQL injection in id should be handled safely."""
        response = api_client.get("/api/v2/playlist-contents/1 OR 1=1")
        assert response.status_code == 404
