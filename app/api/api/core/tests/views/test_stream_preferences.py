...
class TestStreamPreferencesView:
    ...
    def test_stream_pref_endpoint_available_with_api_key(self, api_client):
        """StreamPreferences endpoint should be accessible with API key."""
        response = api_client.get("/api/v2/stream/preferences")
        assert response.status_code == 200

    def test_stream_pref_returns_json(self, api_client):
        """StreamPreferences endpoint should return JSON."""
        response = api_client.get("/api/v2/stream/preferences")
        assert response["Content-Type"] == "application/json"

    def test_stream_pref_response_structure(self, api_client):
    ...
    def test_stream_pref_default_values(self, api_client):
    ...
    def test_stream_pref_custom_fade_transition(self, api_client):
    ...
    def test_stream_pref_custom_message_format(self, api_client):
    ...
    def test_stream_pref_custom_message_offline(self, api_client):
    ...
    def test_stream_pref_replay_gain_enabled_true(self, api_client):
    ...
    def test_stream_pref_custom_replay_gain_offset(self, api_client):
    ...
    def test_stream_pref_data_types(self, api_client):
    ...
    def test_stream_pref_post_not_allowed(self, api_client):
    ...
    def test_stream_pref_put_not_allowed(self, api_client):
    ...
    def test_stream_pref_patch_not_allowed(self, api_client):
    ...
    def test_stream_pref_delete_not_allowed(self, api_client):
        """DELETE should not be allowed on StreamPreferences endpoint."""
        response = api_client.delete("/api/v2/stream/preferences")
        assert response.status_code == 405
    ...
    def test_stream_pref_message_format_values(self, api_client):
    ...
    def test_stream_pref_replay_gain_enabled_variations(self, api_client):
    ...
    def test_stream_pref_user_preferences_ignored(self, api_client):
