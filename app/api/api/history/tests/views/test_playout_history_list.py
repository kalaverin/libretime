...
class TestPlayoutHistoryViewSetList:
    ...
    def test_list_single_file_playout(self, api_client):
    ...
    def test_list_multiple_playouts(self, api_client):
        user = baker.make("core.User", username="testhistory_user")
        file1 = baker.make(
            File,
            name="test1.mp3",
    ...
    def test_list_playout_with_instance(self, api_client):
        user = baker.make("core.User", username="testhistory_user")
    ...
    def test_list_playout_without_ends(self, api_client):
        user = baker.make("core.User", username="testhistory_user")
        file_obj = baker.make(
            File,
            name="test.mp3",
    ...
    def test_list_ordered_by_starts(self, api_client):
        user = baker.make("core.User", username="testhistory_user")
        file1 = baker.make(
            File,
            name="test1.mp3",
