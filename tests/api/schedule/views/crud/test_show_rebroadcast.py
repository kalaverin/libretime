...
class TestShowRebroadcastViewSet:
    ...
    def test_list_rebroadcasts_empty_returns_200(self, guest_client):
        """LIST with no rebroadcasts should return empty array."""
        response = guest_client.get("/api/v2/show-rebroadcasts")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_rebroadcasts_returns_all(self, guest_client):
    ...
    def test_list_rebroadcasts_contains_id(self, guest_client):
    ...
    def test_list_rebroadcasts_contains_show(self, guest_client):
    ...
    def test_list_rebroadcasts_contains_day_offset(self, guest_client):
    ...
    def test_list_rebroadcasts_contains_start_time(self, guest_client):
    ...
    def test_list_rebroadcasts_filter_by_show(self, guest_client):
        ...
        response = guest_client.get(f"/api/v2/show-rebroadcasts?show={show1.id}")
    ...
    def test_create_rebroadcast_success(self, guest_client):
    ...
    def test_create_rebroadcast_multiple_day_offsets(self, guest_client):
    ...
    def test_create_rebroadcast_different_times(self, guest_client):
    ...
    def test_create_rebroadcast_missing_show_fails(self, guest_client):
    ...
    def test_create_rebroadcast_missing_day_offset_fails(self, guest_client):
    ...
    def test_create_rebroadcast_missing_start_time_fails(self, guest_client):
    ...
    def test_create_rebroadcast_invalid_show_fails(self, guest_client):
    ...
    def test_create_rebroadcast_invalid_time_format(self, guest_client):
    ...
    def test_create_rebroadcast_zero_day_offset(self, guest_client):
