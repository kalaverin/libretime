...
class TestPlaylistViewSetList:
    ...
    def test_list_playlists_empty_returns_200(self, admin_client):
        """LIST with no playlists should return empty array."""
        response = admin_client.get("/api/v2/playlists")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_playlists_returns_all(self, admin_client):
    ...
    def test_list_playlists_returns_json(self, admin_client):
    ...
    def test_list_playlists_contains_id(self, admin_client):
    ...
    def test_list_playlists_contains_name(self, admin_client):
    ...
    def test_list_playlists_contains_description(self, admin_client):
    ...
    def test_list_playlists_null_description(self, admin_client):
    ...
    def test_list_playlists_contains_owner(self, admin_client):
    ...
    def test_list_playlists_contains_length(self, admin_client):
    ...
    def test_list_playlists_contains_file_count(self, admin_client):
    ...
    def test_list_playlists_filter_by_owner(self, admin_client):
        ...
        response = admin_client.get(f"/api/v2/playlists?owner={user1.id}")
        assert response.status_code in [200, 400]

    def test_list_playlists_multiple_owners(self, admin_client):
    ...
    def test_list_playlists_unicode_names(self, admin_client):
