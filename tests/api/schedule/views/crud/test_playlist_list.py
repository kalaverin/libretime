...
class TestPlaylistViewSetList:
    ...
    def test_list_playlists_empty_returns_200(self, guest_client):
        """LIST with no playlists should return empty array."""
        response = guest_client.get("/api/v2/playlists")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_playlists_returns_all(self, guest_client):
    ...
    def test_list_playlists_returns_json(self, guest_client):
    ...
    def test_list_playlists_contains_id(self, guest_client):
    ...
    def test_list_playlists_contains_name(self, guest_client):
    ...
    def test_list_playlists_contains_description(self, guest_client):
    ...
    def test_list_playlists_null_description(self, guest_client):
    ...
    def test_list_playlists_contains_owner(self, guest_client):
    ...
    def test_list_playlists_contains_length(self, guest_client):
    ...
    def test_list_playlists_contains_file_count(self, guest_client):
    ...
    def test_list_playlists_filter_by_owner(self, guest_client):
        ...
        response = guest_client.get(f"/api/v2/playlists?owner={user1.id}")
        assert response.status_code in [200, 400]

    def test_list_playlists_multiple_owners(self, guest_client):
    ...
    def test_list_playlists_unicode_names(self, guest_client):
