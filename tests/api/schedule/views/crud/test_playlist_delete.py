...
class TestPlaylistViewSetDelete:
    ...
    def test_delete_playlist_success_returns_204(self, guest_client):
    ...
    def test_delete_playlist_removes_from_db(self, guest_client):
    ...
    def test_delete_playlist_not_found_returns_404(self, guest_client):
        """DELETE non-existent playlist should return 404."""
        response = guest_client.delete("/api/v2/playlists/999999")
    ...
    def test_delete_playlist_double_delete_returns_404(self, guest_client):
    ...
    def test_delete_playlist_returns_empty_body(self, guest_client):
    ...
    def test_delete_one_playlist_others_remain(self, guest_client):
        ...
        guest_client.delete(f"/api/v2/playlists/{playlist2.id}")
    ...
    def test_delete_playlist_with_description(self, guest_client):
    ...
    def test_delete_playlist_id_zero_returns_404(self, guest_client):
        """DELETE with id=0 should return 404."""
        response = guest_client.delete("/api/v2/playlists/0")
        assert response.status_code == 404

    def test_delete_playlist_negative_id_returns_404(self, guest_client):
        """DELETE with negative id should return 404."""
        response = guest_client.delete("/api/v2/playlists/-1")
        assert response.status_code == 404

    def test_delete_playlist_sql_injection_attempt(self, guest_client):
        """DELETE with SQL injection in id should be handled safely."""
        response = guest_client.delete("/api/v2/playlists/1 OR 1=1")
        assert response.status_code == 404
