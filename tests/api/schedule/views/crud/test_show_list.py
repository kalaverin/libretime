...
class TestShowViewSetList:
    ...
    def test_list_shows_empty_returns_200(self, api_client):
        """LIST with no shows should return empty array."""
        response = api_client.get("/api/v2/shows")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_shows_returns_all(self, api_client):
    ...
    def test_list_shows_returns_json(self, api_client):
        """LIST should return JSON response."""
        baker.make(Show, name="Test Show")
        response = api_client.get("/api/v2/shows")
        assert response["Content-Type"] == "application/json"

    def test_list_shows_contains_id(self, api_client):
    ...
    def test_list_shows_contains_name(self, api_client):
    ...
    def test_list_shows_contains_description(self, api_client):
    ...
    def test_list_shows_null_description(self, api_client):
    ...
    def test_list_shows_contains_genre(self, api_client):
    ...
    def test_list_shows_contains_url(self, api_client):
    ...
    def test_list_shows_contains_image(self, api_client):
    ...
    def test_list_shows_contains_colors(self, api_client):
    ...
    def test_list_shows_contains_linked_flags(self, api_client):
    ...
    def test_list_shows_contains_auto_playlist_flags(self, api_client):
    ...
    def test_list_shows_contains_intro_outro_flags(self, api_client):
    ...
    def test_list_shows_live_enabled_false_when_no_auth(self, api_client):
    ...
    def test_list_shows_live_enabled_true_when_custom_auth(self, api_client):
    ...
    def test_list_shows_pagination_limit(self, api_client):
        """LIST should support limit parameter."""
        for i in range(10):
            baker.make(Show, name=f"Show {i}")

        response = api_client.get("/api/v2/shows?limit=5")
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 5
    ...
    def test_list_shows_pagination_offset(self, api_client):
        """LIST should support offset parameter."""
        for i in range(10):
            baker.make(Show, name=f"Show {i}")

        response = api_client.get("/api/v2/shows?limit=5&offset=5")
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 5
    ...
    def test_list_shows_unicode_names(self, api_client):
    ...
    def test_list_shows_long_description(self, api_client):
    ...
    def test_list_shows_with_hosts(self, api_client):
