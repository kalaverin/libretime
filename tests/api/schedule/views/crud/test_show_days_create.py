...
class TestShowDaysViewSetCreate:
    ...
    def test_create_show_days_minimal_success(self, admin_client):
    ...
    def test_create_show_days_with_last_show_on(self, admin_client):
    ...
    def test_create_show_days_with_week_day(self, admin_client):
    ...
    def test_create_show_days_with_record_enabled(self, admin_client):
    ...
    def test_create_show_days_with_repeat_next_on(self, admin_client):
    ...
    def test_create_show_days_missing_show_fails(self, admin_client):
    ...
    def test_create_show_days_missing_first_show_on_fails(self, admin_client):
    ...
    def test_create_show_days_missing_start_time_fails(self, admin_client):
    ...
    def test_create_show_days_returns_json(self, admin_client):
    ...
    def test_create_show_days_invalid_show_fails(self, admin_client):
    ...
    def test_create_show_days_invalid_date_format(self, admin_client):
    ...
    def test_create_show_days_invalid_time_format(self, admin_client):
    ...
    def test_create_show_days_multiple_for_same_show(self, admin_client):
