...
class TestSmartBlockViewSetCreate:
    ...
    def test_create_static_block_success(self, admin_client):
    ...
    def test_create_dynamic_block_success(self, admin_client):
    ...
    def test_create_with_description(self, admin_client):
    ...
    def test_create_default_kind_is_dynamic(self, admin_client):
    ...
    def test_create_unicode_name(self, admin_client):
    ...
    def test_create_long_description(self, admin_client):
    ...
    def test_create_invalid_kind_fails(self, admin_client):
