...
class TestWebstreamViewSetList:
    ...
    def test_list_single_webstream(self, api_client):
    ...
    def test_list_multiple_webstreams(self, api_client):
    ...
    def test_list_with_mime_type(self, api_client):
    ...
    def test_list_long_url(self, api_client):
