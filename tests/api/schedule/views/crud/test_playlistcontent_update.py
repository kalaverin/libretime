...
class TestPlaylistContentViewSetUpdate:
    ...
    def test_patch_update_position_success(self, admin_client):
    ...
    def test_patch_update_cue_points(self, admin_client):
    ...
    def test_patch_update_offset(self, admin_client):
    ...
    def test_patch_update_fade_times(self, admin_client):
    ...
    def test_update_change_playlist(self, admin_client):
    ...
    def test_update_change_content_kind(self, admin_client):
