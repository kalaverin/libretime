...
class TestPlaylistContentViewSetDelete:
    ...
    def test_delete_content_success_returns_204(self, admin_client):
    ...
    def test_delete_content_removes_from_db(self, admin_client):
    ...
    def test_delete_one_content_others_remain(self, admin_client):
        ...
        admin_client.delete(f"/api/v2/playlist-contents/{content2.id}")
