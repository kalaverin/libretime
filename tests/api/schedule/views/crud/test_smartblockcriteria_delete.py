...
class TestSmartBlockCriteriaViewSetDelete:
    ...
    def test_delete_criteria_success_returns_204(self, guest_client):
    ...
    def test_delete_criteria_removes_from_db(self, guest_client):
    ...
    def test_delete_not_found_returns_404(self, guest_client):
        ...
        response = guest_client.delete("/api/v2/smart-block-criteria/999999")
    ...
    def test_delete_one_criteria_others_remain(self, guest_client):
        ...
        guest_client.delete(f"/api/v2/smart-block-criteria/{criteria2.id}")
