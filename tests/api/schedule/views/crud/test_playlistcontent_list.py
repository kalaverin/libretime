...
class TestPlaylistContentViewSetList:
    ...
    def test_list_single_file_content(self, admin_client):
    ...
    def test_list_single_stream_content(self, admin_client):
    ...
    def test_list_single_block_content(self, admin_client):
    ...
    def test_list_filter_by_playlist(self, admin_client):
    ...
    def test_list_null_relations_for_different_kinds(self, admin_client):
