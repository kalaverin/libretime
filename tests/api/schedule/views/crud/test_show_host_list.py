...
class TestShowHostViewSetList:
    ...
    def test_list_show_hosts_empty_returns_200(self, guest_client):
        """LIST with no show hosts should return empty array."""
        response = guest_client.get("/api/v2/show-hosts")
        assert response.status_code == 200
        assert response.json() == []

    def test_list_show_hosts_returns_all(self, guest_client):
    ...
    def test_list_show_hosts_contains_id(self, guest_client):
    ...
    def test_list_show_hosts_contains_show(self, guest_client):
    ...
    def test_list_show_hosts_contains_user(self, guest_client):
    ...
    def test_list_show_hosts_multiple_shows(self, guest_client):
    ...
    def test_list_show_hosts_multiple_hosts_same_show(self, guest_client):
    ...
    def test_list_show_hosts_filter_by_show(self, guest_client):
        ...
        response = guest_client.get(f"/api/v2/show-hosts?show={show1.id}")
        # Filtering may or may not be supported
        assert response.status_code in [200, 400]

    def test_list_show_hosts_filter_by_user(self, guest_client):
        ...
        response = guest_client.get(f"/api/v2/show-hosts?user={user.id}")
        # Filtering may or may not be supported
        assert response.status_code in [200, 400]
    ...
    def test_list_show_hosts_returns_json(self, guest_client):
