...
class TestShowViewSetCreate:
    ...
    def test_create_show_minimal_success(self, admin_client):
    ...
    def test_create_show_with_description(self, admin_client):
    ...
    def test_create_show_with_genre(self, admin_client):
    ...
    def test_create_show_with_url(self, admin_client):
    ...
    def test_create_show_with_colors(self, admin_client):
    ...
    def test_create_show_missing_name_fails(self, admin_client):
    ...
    def test_create_show_missing_linked_fails(self, admin_client):
    ...
    def test_create_show_missing_linkable_fails(self, admin_client):
    ...
    def test_create_show_returns_json(self, admin_client):
    ...
    def test_create_show_unicode_name(self, admin_client):
    ...
    def test_create_show_long_description(self, admin_client):
    ...
    def test_create_show_with_live_auth_registered(self, admin_client):
    ...
    def test_create_show_with_live_auth_custom(self, admin_client):
    ...
    def test_create_show_with_auto_playlist_enabled(self, admin_client):
    ...
    def test_create_show_duplicate_name_fails(self, admin_client):
    ...
    def test_create_show_empty_name_fails(self, admin_client):
    ...
    def test_create_show_name_too_long_fails(self, admin_client):
    ...
    def test_create_show_invalid_color_format(self, admin_client):
