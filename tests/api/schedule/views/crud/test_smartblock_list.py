...
class TestSmartBlockViewSetList:
    ...
    def test_list_single_static_block(self, api_client):
    ...
    def test_list_single_dynamic_block(self, api_client):
    ...
    def test_list_multiple_blocks(self, api_client):
    ...
    def test_list_with_description(self, api_client):
    ...
    def test_list_unicode_names(self, api_client):
