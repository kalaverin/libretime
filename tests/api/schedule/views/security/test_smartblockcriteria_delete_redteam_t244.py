...
class TestSmartBlockCriteriaDeleteRedTeam:
    ...
    def test_bola_delete_other_users_criteria_status(self, admin_client):
    ...
    def test_error_message_leaks_existence(self, admin_client):
        ...
        response_nonexistent = admin_client.delete(
    ...
    def test_id_enumeration_timing_attack(self, admin_client):
        ...
        start = time.time()
        admin_client.delete("/api/v2/smart-block-criteria/999999")
    ...
    def test_delete_all_criteria_from_block(self, admin_client):
        ...
        assert SmartBlock.objects.filter(
            id=block.id,
        ).exists(), "Block was deleted when all criteria removed"
    ...
    def test_delete_unicode_id(self, admin_client):
        ...
        response = admin_client.delete("/api/v2/smart-block-criteria/日本語")
        assert response.status_code in [
            400,
            404,
    ...
    def test_delete_null_bytes(self, admin_client):
        ...
        response = admin_client.delete("/api/v2/smart-block-criteria/1%00test")
        assert response.status_code in [
            400,
            404,
