...
class TestPlaylistContentUpdateRedTeam:
    ...
    def test_bola_update_other_users_content(self, admin_client):
    ...
    def test_bola_move_content_to_other_playlist(self, admin_client):
    ...
    def test_bopla_update_id_field(self, admin_client):
    ...
    def test_race_condition_concurrent_updates(self, admin_client):
    ...
    def test_update_sql_injection_in_fields(self, admin_client):
    ...
    def test_update_negative_position(self, admin_client):
    ...
    def test_update_nonexistent_content(self, admin_client):
    ...
    def test_update_rapid_fire(self, admin_client):
    ...
    def test_mass_assignment_readonly_fields(self, admin_client):
