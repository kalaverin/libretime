...
class TestWebstreamCreateRedTeam:
    ...
    def test_bopla_create_with_other_user_owner(self, admin_client):
    ...
    def test_bopla_mass_assignment_timestamps(self, admin_client):
    ...
    def test_ssrf_internal_url(self, admin_client):
    ...
    def test_ssrf_cloud_metadata(self, admin_client):
    ...
    def test_url_scheme_validation(self, admin_client):
    ...
    def test_sqli_in_name_field(self, admin_client):
    ...
    def test_sqli_in_description_field(self, admin_client):
    ...
    def test_sqli_in_url_field(self, admin_client):
    ...
    def test_xss_in_name_field(self, admin_client):
    ...
    def test_xss_in_description_field(self, admin_client):
    ...
    def test_name_length_validation(self, admin_client):
    ...
    def test_empty_name_validation(self, admin_client):
