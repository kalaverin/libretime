...
class TestSmartBlockCreateRedTeam:
    ...
    def test_bopla_mass_assignment_id(self, admin_client):
    ...
    def test_bopla_mass_assignment_created_at(self, admin_client):
    ...
    def test_create_sql_injection_name(self, admin_client):
    ...
    def test_create_sql_injection_description(self, admin_client):
    ...
    def test_create_whitespace_name(self, admin_client):
    ...
    def test_create_invalid_kind(self, admin_client):
    ...
    def test_create_unicode_injection(self, admin_client):
...
class TestSmartBlockCreateAdvancedRedTeam:
    ...
    def test_bopla_mass_assignment_owner(self, admin_client):
    ...
    def test_bopla_mass_assignment_updated_at(self, admin_client):
    ...
    def test_bopla_mass_assignment_length(self, admin_client):
    ...
    def test_create_content_type_confusion_text_plain(self, admin_client):
    ...
    def test_create_content_type_confusion_form_data(self, admin_client):
    ...
    def test_create_http_method_override(self, admin_client):
    ...
    def test_create_json_key_collision(self, admin_client):
    ...
    def test_create_json_deeply_nested(self, admin_client):
    ...
    def test_create_json_unicode_escape(self, admin_client):
    ...
    def test_create_null_bytes_in_name(self, admin_client):
    ...
    def test_create_negative_length(self, admin_client):
    ...
    def test_create_name_only_whitespace_variations(self, admin_client):
    ...
    def test_create_name_with_control_chars(self, admin_client):
    ...
    def test_create_nosql_injection_kind(self, admin_client):
    ...
    def test_create_race_condition_duplicate_names(self, admin_client):
    ...
    def test_create_fuzzing_naughty_strings_name(self, admin_client):
    ...
    def test_create_fuzzing_overflow_values(self, admin_client):
