...
class TestSmartBlockContentFilterInjection:
    ...
    def test_filter_by_invalid_block_id(self, admin_client, admin_user):
        ...
        response = admin_client.get("/api/v2/smart-block-contents?block=invalid")
    ...
    def test_filter_by_very_large_block_id(self, admin_client, admin_user):
...
class TestSmartBlockContentInformationDisclosure:
    ...
    def test_timing_attack_on_filter(self, admin_client, admin_user):
        ...
        start = time.time()
        response1 = admin_client.get("/api/v2/smart-block-contents?block=1")
        time_valid = time.time() - start

        # Request with invalid filter
        start = time.time()
        response2 = admin_client.get("/api/v2/smart-block-contents?block=999999")
...
class TestSmartBlockContentPagination:
    ...
    def test_large_limit_parameter(self, admin_client, admin_user):
        ...
        response = admin_client.get("/api/v2/smart-block-contents?limit=999999")
    ...
    def test_negative_limit(self, admin_client, admin_user):
        ...
        response = admin_client.get("/api/v2/smart-block-contents?limit=-1")
    ...
    def test_negative_offset(self, admin_client, admin_user):
        ...
        response = admin_client.get("/api/v2/smart-block-contents?offset=-1")
...
class TestSmartBlockContentMassOrdering:
    ...
    def test_extract_all_content_via_ordering(
        ...
        # Get first page
        response = admin_client.get("/api/v2/smart-block-contents?limit=5")
        assert response.status_code == 200
