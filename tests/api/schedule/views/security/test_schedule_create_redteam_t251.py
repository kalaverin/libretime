...
class TestScheduleCreateRedTeam:
    ...
    def test_bola_create_schedule_for_other_user_show(self, admin_client, faker):
    ...
    def test_bopla_mass_assignment_id(self, admin_client, faker):
    ...
    def test_bopla_mass_assignment_readonly(self, admin_client, faker):
    ...
    def test_business_logic_schedule_overlap(self, admin_client, faker):
    ...
    def test_business_logic_outside_show_time(self, admin_client, faker):
    ...
    def test_sqli_in_create_fields(self, admin_client, faker):
    ...
    def test_nosql_injection_in_create(self, admin_client, faker):
    ...
    def test_unicode_in_create_fields(self, admin_client, faker):
    ...
    def test_negative_position(self, admin_client, faker):
    ...
    def test_invalid_date_formats(self, admin_client, faker):
    ...
    def test_create_error_reveals_field_info(self, admin_client, faker):
    ...
    def test_race_condition_concurrent_create(self, admin_client, faker):
