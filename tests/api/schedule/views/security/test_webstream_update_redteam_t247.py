...
class TestWebstreamUpdateRedTeam:
    ...
    def test_idor_stream_enumeration(self, api_client):
    ...
    def test_bopla_change_owner_on_update(self, api_client):
    ...
    def test_xss_update_name(self, api_client):
    ...
    def test_sqli_in_update_name(self, api_client):
    ...
    def test_put_full_update_ssrf(self, api_client):
    ...
    def test_update_nonexistent_stream(self, api_client):
    ...
    def test_race_condition_concurrent_update(self, api_client):
