...
class TestSmartBlockCriteriaCreateRedTeam:
    ...
    def test_bola_create_for_other_users_block(self, admin_client):
    ...
    def test_sqli_in_criteria_field(self, admin_client):
    ...
    def test_sqli_in_condition_field(self, admin_client):
    ...
    def test_sqli_in_value_field(self, admin_client):
    ...
    def test_sqli_in_extra_field(self, admin_client):
    ...
    def test_overflow_criteria_value(self, admin_client):
    ...
    def test_unicode_injection_value_field(self, admin_client):
    ...
    def test_negative_group_value(self, admin_client):
    ...
    def test_duplicate_criteria_same_block(self, admin_client):
    ...
    def test_invalid_criteria_type(self, admin_client):
    ...
    def test_invalid_condition_type(self, admin_client):
