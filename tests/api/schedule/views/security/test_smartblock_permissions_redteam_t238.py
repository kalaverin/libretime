...
class TestSmartBlockPermissionsRedTeam:
    ...
    def test_bola_list_shows_all_users_blocks(self, admin_client):
    ...
    def test_bola_retrieve_other_users_private_block(self, admin_client):
        ...
        response = admin_client.get(f"/api/v2/smart-blocks/{private_block.id}")
    ...
    def test_bola_block_id_enumeration(self, admin_client):
        ...
        for i in range(1, 200):
            response = admin_client.get(f"/api/v2/smart-blocks/{i}")
    ...
    def test_bfla_admin_bulk_delete_accessible(self, admin_client):
    ...
    def test_bfla_admin_export_not_accessible(self, admin_client):
        """BFLA: Admin export endpoint should not exist or be restricted."""
        response = admin_client.get("/api/v2/smart-blocks/export")
    ...
    def test_bfla_admin_import_accessible(self, admin_client):
    ...
    def test_privesc_host_to_admin_actions(self, admin_client):
    ...
    def test_privesc_dj_role_bypass(self, admin_client):
    ...
    def test_privesc_guest_role_access(self, admin_client):
    ...
    def test_auth_bypass_session_vs_api_key(self, admin_client, client):
        """Auth: Compare session auth vs API key behavior."""
        # API key auth (via admin_client fixture)
        response_api = admin_client.get("/api/v2/smart-blocks")
    ...
    def test_auth_bypass_case_insensitive_headers(self, admin_client):
    ...
    def test_auth_bypass_empty_token(self, admin_client):
    ...
    def test_perm_enum_error_messages_consistent(self, admin_client):
    ...
    def test_hpp_duplicate_permission_params(self, admin_client):
    ...
    def test_hpp_permission_override_via_query(self, admin_client):
    ...
    def test_perm_mass_assignment_role_escalation(self, admin_client):
    ...
    def test_api_version_unauthorized_access(self, admin_client):
        """API Version: Try deprecated/unauthorized versions."""
        versions = ["v1", "v3", "internal", "admin", "beta"]

        for version in versions:
            response = admin_client.get(f"/api/{version}/smart-blocks")
    ...
    def test_cors_preflight_permissions(self, admin_client):
