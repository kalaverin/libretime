...
class TestSmartBlockCriteriaUpdateRedTeam:
    ...
    def test_bola_update_other_users_criteria(self, admin_client):
    ...
    def test_bola_delete_other_users_criteria(self, admin_client):
    ...
    def test_idor_criteria_enumeration(self, admin_client):
    ...
    def test_block_takeover_via_update(self, admin_client):
    ...
    def test_sqli_in_update_value(self, admin_client):
    ...
    def test_sqli_in_update_criteria_field(self, admin_client):
    ...
    def test_mass_assignment_id_on_update(self, admin_client):
    ...
    def test_put_full_update_block_takeover(self, admin_client):
    ...
    def test_update_nonexistent_criteria(self, admin_client):
    ...
    def test_update_empty_value(self, admin_client):
    ...
    def test_update_very_long_value(self, admin_client):
