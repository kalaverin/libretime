...
class TestWebstreamListRedTeam:
    ...
    @pytest.mark.xfail(reason="BOLA: LIST shows all users' webstreams")
    ...
    def test_stream_id_enumeration_mitigated(self, admin_client):
    ...
    def test_field_exposure_all_fields_review(self, admin_client):
    ...
    def test_url_field_ssrf_reflection(self, admin_client):
    ...
    def test_mime_type_arbitrary_values(self, admin_client):
    ...
    def test_url_length_overflow(self, admin_client):
    ...
    def test_url_format_validation(self, admin_client):
    ...
    def test_pagination_page_size_limits(self, admin_client):
        ...
        response = admin_client.get("/api/v2/webstreams?page_size=999999")
    ...
    def test_sorting_sql_injection_attempt(self, admin_client):
    ...
    def test_timing_empty_vs_populated(self, admin_client):
        """Timing: Difference between empty and populated list."""
        import time

        # Time empty list
        start = time.time()
        response1 = admin_client.get("/api/v2/webstreams")
        ...
        # Time populated list
        start = time.time()
        response2 = admin_client.get("/api/v2/webstreams")
    ...
    def test_description_xss_protection(self, admin_client):
    ...
    def test_unicode_in_name_handling(self, admin_client):
