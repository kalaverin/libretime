...
class TestPlaylistContentDeleteRedTeam:
    ...
    def test_bola_delete_other_users_content(self, admin_client):
    ...
    def test_bola_mass_delete_other_users_contents(self, admin_client):
        ...
        deleted = 0
        for c in contents:
            r = admin_client.delete(f"/api/v2/playlist-contents/{c.id}")
    ...
    def test_delete_rapid_fire(self, admin_client):
        ...
        start = time.time()
        for c in contents:
            admin_client.delete(f"/api/v2/playlist-contents/{c.id}")
    ...
    def test_race_double_delete(self, admin_client):
        ...
        def delete():
            return admin_client.delete(f"/api/v2/playlist-contents/{content.id}")
    ...
    def test_delete_nonexistent(self, admin_client):
        ...
        response = admin_client.delete("/api/v2/playlist-contents/999999")
        assert response.status_code == 404

    def test_delete_already_deleted(self, admin_client):
        ...
        admin_client.delete(f"/api/v2/playlist-contents/{content.id}")
        response = admin_client.delete(f"/api/v2/playlist-contents/{content.id}")

        assert response.status_code == 404

    def test_delete_sql_injection_id(self, admin_client):
