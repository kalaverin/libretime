...
class TestScheduleShowHostPermissionsRedTeam:
    ...
    def test_host_can_create_schedule_own_show(self, admin_client, faker):
    ...
    def test_host_cannot_modify_other_host_show(self, admin_client, faker):
        ...
        # Attacker host
        attacker_host = baker.make(
            User,
            username=f"testred_attacker_{faker.user_name()}",
            role=Role.HOST,
        )
        admin_client.force_authenticate(user=attacker_host)
    ...
    def test_host_cannot_delete_other_host_show(self, admin_client, faker):
    ...
    def test_admin_can_modify_any_host_schedule(self, admin_client, faker):
    ...
    def test_guest_cannot_modify_host_schedule(self, admin_client, faker):
    ...
    def test_show_host_permission_check(self, admin_client, faker):
        """Verify show host is properly checked for schedule operations."""
        host = baker.make(
            User,
            username=f"testred_creator_{faker.user_name()}",
            role=Role.HOST,
        )
        show = baker.make(Show, name=faker.catch_phrase())
        baker.make(ShowHost, show=show, user=host)
    ...
    def test_host_multiple_shows_isolation(self, admin_client, faker):
    ...
    def test_idor_instance_enumeration(self, admin_client, faker):
    ...
    def test_host_privilege_escalation(self, admin_client, faker):
