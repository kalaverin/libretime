...
class TestPlayoutHistoryValidationBypass:
    ...
    def test_create_with_null_starts(self, guest_client, admin_user):
    ...
    def test_create_with_null_ends(self, guest_client, admin_user):
    ...
    def test_create_with_same_starts_and_ends(self, guest_client, admin_user):
    ...
    def test_create_with_negative_duration(self, guest_client, admin_user):
    ...
    def test_create_with_future_dates(self, guest_client, admin_user):
...
class TestPlayoutHistoryMassAssignment:
    ...
    def test_update_file_field(self, guest_client, admin_user):
    ...
    def test_update_timestamps(self, guest_client, admin_user):
...
class TestPlayoutHistoryBOLA:
    ...
    def test_access_other_user_history(
        ...
        guest_client.force_authenticate(user=regular_user)
        response = guest_client.get(f"/api/v2/playout-history/{history.id}")
    ...
    def test_delete_other_user_history(
        ...
        guest_client.force_authenticate(user=regular_user)
        response = guest_client.delete(f"/api/v2/playout-history/{history.id}")
...
class TestPlayoutHistoryBusinessLogic:
    ...
    def test_create_with_invalid_datetime_format(self, guest_client, admin_user):
    ...
    def test_create_with_very_long_duration(self, guest_client, admin_user):
