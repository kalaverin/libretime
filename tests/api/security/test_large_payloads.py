...
class TestLargePlaylistCreation:
    ...
    def test_create_playlist_with_50_contents(self, admin_client):
    ...
    def test_create_playlist_with_100_contents(self, admin_client):
    ...
    def test_large_playlist_list_response(self, admin_client):
...
class TestLargeNameAndDescription:
    ...
    def test_max_length_playlist_name(self, admin_client):
    ...
    def test_max_length_description(self, admin_client):
    ...
    def test_unicode_name(self, admin_client):
...
class TestLargeBulkOperations:
    ...
    def test_filter_large_dataset(self, admin_client):
        ...
        response = admin_client.get("/api/v2/files?mime=audio/mp3")
        assert response.status_code == 200
        data = response.json()
        assert len(data) >= 100

    def test_large_response_serialization(self, admin_client):
...
class TestPayloadSizeLimits:
    ...
    def test_large_valid_json_payload(self, admin_client):
    ...
    def test_many_fields_in_payload(self, admin_client):
...
class TestDataIntegrityWithLargePayloads:
    ...
    def test_position_integrity_with_many_items(self, admin_client):
    ...
    def test_no_missing_items_in_large_list(self, admin_client):
    ...
    def test_total_count_consistency(self, admin_client):
