...
class TestShowDaysRetrieveAuthentication:
    ...
    def test_retrieve_without_auth(self, admin_client):
        """Anonymous RETRIEVE should fail."""
        show = baker.make(Show, name="Test Show")
        show_days = baker.make(ShowDays, show=show)

        response = admin_client.get(f"/api/v2/show-days/{show_days.id}")
...
class TestShowDaysUpdateMassAssignment:
    ...
    def test_update_created_at(self, admin_client):
...
class TestShowDaysUpdateSQLInjection:
    ...
    def test_update_sqli_in_start_time(self, admin_client, admin_user):
    ...
    def test_update_sqli_in_timezone(self, admin_client, admin_user):
...
class TestShowDaysUpdateTimeManipulation:
    ...
    def test_update_to_negative_duration(self, admin_client):
    ...
    def test_update_invalid_week_day(self, admin_client):
    ...
    def test_update_last_show_before_first(self, admin_client):
...
class TestShowDaysUpdateRepeatAbuse:
    ...
    def test_update_repeat_next_on(self, admin_client):
    ...
    def test_update_invalid_repeat_kind(self, admin_client):
...
class TestShowDaysDeleteAuthentication:
    ...
    def test_delete_without_auth(self, admin_client):
        ...
        response = admin_client.delete(f"/api/v2/show-days/{show_days.id}")
        assert response.status_code in [
            401,
            403,
...
class TestShowDaysDeleteBOLA:
    ...
    def test_delete_other_user_show_days(
        ...
        admin_client.force_authenticate(user=regular_user)
        response = admin_client.delete(f"/api/v2/show-days/{show_days_id}")
        assert response.status_code in [
            403,
            404,
