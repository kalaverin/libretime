...
class TestSilenceProcessingBOLA:
    ...
    def test_cross_user_silence_processing_blocked(self, admin_client, faker):
...
class TestSilenceProcessingMassAssignment:
    ...
    def test_mass_assignment_import_status_blocked(self, admin_client, faker):
    ...
    def test_mass_assignment_extreme_channels_blocked(self, admin_client, faker):
...
class TestSilenceProcessingSQLInjection:
    ...
    def test_sqli_in_import_status_filter_no_crash(
        ...
        response = admin_client.get(f"/api/v2/files?{payload}")

        # Should not crash with 500
        assert response.status_code != 500, f"SQLi caused 500: {payload[:50]}"
        assert response.status_code in [200, 400]

    def test_sqli_in_channels_filter_no_crash(self, admin_client, faker):
...
class TestSilenceProcessingMIMEConfusion:
    ...
    def test_invalid_mime_type_handled(self, mime_type, admin_client, faker):
    ...
    def test_mime_spoofing_for_silence_processing(self, admin_client, faker):
...
class TestSilenceProcessingResourceExhaustion:
    ...
    def test_extreme_duration_handled(self, duration, admin_client, faker):
    ...
    def test_batch_processing_limits(self, admin_client, faker):
...
class TestSilenceProcessingWorkflowBypass:
    ...
    def test_pending_to_success_bypass_blocked(self, admin_client, faker):
    ...
    @pytest.mark.xfail(reason="Workflow bypass possible - T891", strict=False)
    def test_failed_to_success_bypass_blocked(self, admin_client, faker):
...
class TestSilenceProcessingInformationDisclosure:
    ...
    def test_no_internal_paths_in_errors(self, admin_client, faker):
    ...
    def test_no_stack_traces_in_response(self, admin_client, faker):
        ...
        response = admin_client.get("/api/v2/files?import_status=invalid")
