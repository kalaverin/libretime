...
class TestPlaylistUpdateXSS:
    ...
    def test_xss_in_name_via_patch(self, admin_client):
...
class TestPlaylistUpdateSQLInjection:
    ...
    def test_sqli_in_name_via_patch(self, admin_client):
...
class TestPlaylistUpdateValidation:
    ...
    def test_update_to_empty_name(self, admin_client):
    ...
    def test_update_to_whitespace_name(self, admin_client):
