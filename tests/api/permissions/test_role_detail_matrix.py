...
def create_test_entity(
    entity_type: str, owner: User | None = None, faker=None,
):
...
class TestDetailPermissionMatrix:
    ...
    def test_host_can_retrieve_own_playlist_detail(
    ...
    def test_host_can_retrieve_other_playlist_detail(self, host_client, faker):
        ...
        playlist = create_test_entity(
            "playlist", owner=other_user, faker=faker,
        )
    ...
    def test_host_can_retrieve_other_smartblock_detail(
    ...
    def test_host_can_retrieve_other_webstream_detail(
        self, host_client, faker,
    ):
    ...
    def test_manager_can_retrieve_host_playlist_detail(
...
class TestDetailCrossRoleConsistency:
    ...
    def test_all_roles_see_same_playlist_data(
        ...
        manager_data = manager_client.get(
