...
class TestMountNameViewSet:
    ...
    def test_list_empty_returns_200(self):
        ...
        response = self.admin_client.get("/api/v2/mount-names")
    ...
    def test_retrieve_mount_success(self):
        ...
        response = self.admin_client.get(f"/api/v2/mount-names/{mount.id}")
    ...
    def test_retrieve_not_found(self):
        ...
        response = self.admin_client.get("/api/v2/mount-names/99999")
    ...
    def test_delete_mount_success(self):
        ...
        response = self.admin_client.delete(f"/api/v2/mount-names/{mount.id}")
    ...
    def test_delete_not_found(self):
        ...
        response = self.admin_client.delete("/api/v2/mount-names/99999")
        assert response.status_code == 404
