...
class TestLibraryViewSetUpdate:
    ...
    def test_patch_update_enabled_success(self, admin_client):
    ...
    def test_patch_update_analyze_cue_points_success(self, admin_client):
    ...
    def test_update_code_unique_constraint(self, admin_client):
    ...
    def test_update_code_to_same_value_succeeds(self, admin_client):
    ...
    def test_update_long_code_fails(self, admin_client):
    ...
    def test_update_long_name_fails(self, admin_client):
