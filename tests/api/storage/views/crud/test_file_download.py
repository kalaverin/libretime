...
class TestFileViewSetDownload:
    ...
    def test_download_success(self, guest_client):
    ...
    def test_download_x_accel_redirect_header_format(self, guest_client):
    ...
    def test_download_not_found(self, guest_client):
    ...
    def test_download_invalid_id_format(self, guest_client):
        """DOWNLOAD with invalid ID format should return 404."""
        response = guest_client.get("/api/v2/files/abc/download")
        assert response.status_code == 404

    def test_download_unicode_filepath(self, guest_client):
    ...
    def test_download_special_chars_filepath(self, guest_client):
    ...
    def test_download_long_filepath(self, guest_client):
    ...
    def test_download_no_filepath(self, guest_client):
    ...
    def test_download_empty_filepath(self, guest_client):
    ...
    def test_download_path_traversal_attempt(self, guest_client):
    ...
    def test_download_response_has_no_body(self, guest_client):
    ...
    def test_download_post_not_allowed(self, guest_client):
        ...
        response = guest_client.post(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_put_not_allowed(self, guest_client):
        ...
        response = guest_client.put(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_patch_not_allowed(self, guest_client):
        ...
        response = guest_client.patch(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_delete_not_allowed(self, guest_client):
        ...
        response = guest_client.delete(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    @pytest.mark.xfail(
        reason="URL routing: /download/ returns 404, should redirect or work",
    )
    def test_download_url_with_trailing_slash(self, guest_client):
