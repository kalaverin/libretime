...
class TestFileViewSetDownload:
    ...
    def test_download_success(self, admin_client):
    ...
    def test_download_x_accel_redirect_header_format(self, admin_client):
    ...
    def test_download_invalid_id_format(self, admin_client):
        """DOWNLOAD with invalid ID format should return 404."""
        response = admin_client.get("/api/v2/files/abc/download")
        assert response.status_code == 404

    def test_download_unicode_filepath(self, admin_client):
    ...
    def test_download_special_chars_filepath(self, admin_client):
    ...
    def test_download_long_filepath(self, admin_client):
    ...
    def test_download_no_filepath(self, admin_client):
    ...
    def test_download_empty_filepath(self, admin_client):
    ...
    def test_download_path_traversal_attempt(self, admin_client):
    ...
    def test_download_response_has_no_body(self, admin_client):
    ...
    def test_download_post_not_allowed(self, admin_client):
        ...
        response = admin_client.post(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_put_not_allowed(self, admin_client):
        ...
        response = admin_client.put(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_patch_not_allowed(self, admin_client):
        ...
        response = admin_client.patch(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    def test_download_delete_not_allowed(self, admin_client):
        ...
        response = admin_client.delete(f"/api/v2/files/{file.id}/download")
        assert response.status_code == 405

    @pytest.mark.xfail(
        reason="URL routing: /download/ returns 404, should redirect or work",
    )
    def test_download_url_with_trailing_slash(self, admin_client):
