...
class TestFilePathOrganization:
    ...
    def test_filepath_storage(self, admin_client):
    ...
    def test_nested_directory_structure(self, admin_client):
    ...
    def test_unicode_filepath(self, admin_client):
    ...
    def test_relative_filepath(self, admin_client):
...
class TestLibraryOrganization:
    ...
    def test_file_in_library(self, admin_client):
    ...
    def test_file_without_library(self, admin_client):
    ...
    def test_files_by_library(self, admin_client):
...
class TestImportStatusOrganization:
    ...
    def test_success_status(self, admin_client):
    ...
    def test_pending_status(self, admin_client):
    ...
    def test_failed_status(self, admin_client):
...
class TestFileSizeOrganization:
    ...
    def test_small_file(self, admin_client):
        """Small file size."""
    ...
    def test_large_file(self, admin_client):
        """Large file size."""
    ...
    def test_zero_size_file(self, admin_client):
        """Zero size file."""
...
class TestFileOrganizationUpdates:
    ...
    def test_move_to_different_library(self, admin_client):
    ...
    def test_update_filepath(self, admin_client):
