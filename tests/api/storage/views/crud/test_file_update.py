...
class TestFileViewSetUpdate:
    ...
    def test_patch_update_metadata_success(self, guest_client):
    ...
    def test_patch_update_genre(self, guest_client):
    ...
    def test_patch_clear_nullable_field(self, guest_client):
    ...
    def test_patch_update_library(self, guest_client):
