...
class TestLibraryViewSetDelete:
    ...
    def test_delete_library_success_returns_204(self, admin_client):
        ...
        response = admin_client.delete(f"/api/v2/libraries/{lib.id}")
        assert response.status_code == 204

    def test_delete_library_removes_from_db(self, admin_client):
        ...
        admin_client.delete(f"/api/v2/libraries/{lib.id}")
        assert Library.objects.filter(id=lib.id).count() == 0

    def test_delete_library_not_found_returns_404(self, admin_client):
        """DELETE non-existent library should return 404."""
        response = admin_client.delete("/api/v2/libraries/999999")
    ...
    def test_delete_library_with_files_sets_null(self, admin_client):
    ...
    def test_delete_library_files_preserved(self, admin_client):
    ...
    def test_delete_library_empty_succeeds(self, admin_client):
    ...
    def test_delete_library_multiple_files(self, admin_client):
    ...
    def test_delete_library_double_delete_returns_404(self, admin_client):
    ...
    def test_delete_library_wrong_method_returns_405(self, admin_client):
    ...
    def test_delete_library_unicode_code(self, admin_client):
    ...
    def test_delete_library_returns_empty_body(self, admin_client):
    ...
    def test_delete_library_cascade_to_track_types(self, admin_client):
    ...
    def test_delete_library_id_zero_returns_404(self, admin_client):
        """DELETE with id=0 should return 404."""
        response = admin_client.delete("/api/v2/libraries/0")
        assert response.status_code == 404

    def test_delete_library_negative_id_returns_404(self, admin_client):
        """DELETE with negative id should return 404."""
        response = admin_client.delete("/api/v2/libraries/-1")
        assert response.status_code == 404

    def test_delete_library_large_id_returns_404(self, admin_client):
        """DELETE with very large id should return 404."""
        response = admin_client.delete("/api/v2/libraries/999999999")
        assert response.status_code == 404

    def test_delete_library_sql_injection_attempt(self, admin_client):
        """DELETE with SQL injection in id should be handled safely."""
        # Django ORM should sanitize this
        response = admin_client.delete("/api/v2/libraries/1 OR 1=1")
        assert response.status_code == 404

    def test_delete_library_path_traversal_attempt(self, admin_client):
        """DELETE with path traversal in id should be handled safely."""
        response = admin_client.delete("/api/v2/libraries/../../../etc/passwd")
        assert response.status_code == 404

    def test_delete_library_special_chars_in_id(self, admin_client):
        """DELETE with special chars in id should return 404."""
        response = admin_client.delete("/api/v2/libraries/test%20id")
        assert response.status_code == 404
