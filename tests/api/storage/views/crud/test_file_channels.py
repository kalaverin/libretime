...
class TestMonoFileDetection:
    ...
    def test_mono_file_channels(self, admin_client):
    ...
    def test_mono_file_retrieve(self, admin_client):
    ...
    def test_mono_in_list(self, admin_client):
...
class TestStereoFileDetection:
    ...
    def test_stereo_file_channels(self, admin_client):
    ...
    def test_stereo_file_retrieve(self, admin_client):
    ...
    def test_stereo_in_list(self, admin_client):
...
class TestSurroundFileDetection:
    ...
    def test_5_1_surround(self, admin_client):
    ...
    def test_7_1_surround(self, admin_client):
    ...
    def test_quadraphonic(self, admin_client):
...
class TestChannelFiltering:
    ...
    def test_filter_by_mono(self, admin_client):
        """Filter mono files."""
    ...
    def test_mixed_channels_in_list(self, admin_client):
...
class TestChannelUpdate:
    ...
    def test_update_mono_to_stereo(self, admin_client):
    ...
    def test_update_stereo_to_mono(self, admin_client):
    ...
    def test_clear_channels(self, admin_client):
...
class TestChannelEdgeCases:
    ...
    def test_null_channels(self, admin_client):
    ...
    def test_zero_channels_invalid(self, admin_client):
