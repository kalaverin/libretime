...
class TestTestSuiteHealth:
    ...
    def test_critical_tests_present(self):
        ...
        critical_files = [
            "tests/api/core/views/security/test_auth_session.py",
            "tests/api/core/views/permissions/test_permissions.py",
            "tests/api/core/crud/test_cascade_deletes.py",
        ]
