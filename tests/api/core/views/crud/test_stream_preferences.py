...
class TestStreamPreferencesView:
    ...
    def test_stream_pref_endpoint_available_with_api_key(self, admin_client):
        """StreamPreferences endpoint should be accessible with API key."""
        response = admin_client.get("/api/v2/stream/preferences")
        assert response.status_code == 200

    def test_stream_pref_returns_json(self, admin_client):
        """StreamPreferences endpoint should return JSON."""
        response = admin_client.get("/api/v2/stream/preferences")
        assert response["Content-Type"] == "application/json"

    def test_stream_pref_response_structure(self, admin_client):
    ...
    def test_stream_pref_default_values(self, admin_client):
    ...
    def test_stream_pref_custom_fade_transition(self, admin_client):
    ...
    def test_stream_pref_custom_message_format(self, admin_client):
    ...
    def test_stream_pref_custom_message_offline(self, admin_client):
    ...
    def test_stream_pref_replay_gain_enabled_true(self, admin_client):
    ...
    def test_stream_pref_custom_replay_gain_offset(self, admin_client):
    ...
    def test_stream_pref_data_types(self, admin_client):
    ...
    def test_stream_pref_post_not_allowed(self, admin_client):
    ...
    def test_stream_pref_put_not_allowed(self, admin_client):
    ...
    def test_stream_pref_patch_not_allowed(self, admin_client):
    ...
    def test_stream_pref_delete_not_allowed(self, admin_client):
        """DELETE should not be allowed on StreamPreferences endpoint."""
        response = admin_client.delete("/api/v2/stream/preferences")
        assert response.status_code == 405
    ...
    def test_stream_pref_message_format_values(self, admin_client):
    ...
    def test_stream_pref_replay_gain_enabled_variations(self, admin_client):
    ...
    def test_stream_pref_user_preferences_ignored(self, admin_client):
