...
class TestStreamStateView:
    ...
    def test_stream_state_endpoint_available_with_api_key(self, admin_client):
        """StreamState endpoint should be accessible with API key."""
        response = admin_client.get("/api/v2/stream/state")
        assert response.status_code == 200

    def test_stream_state_returns_json(self, admin_client):
        """StreamState endpoint should return JSON."""
        response = admin_client.get("/api/v2/stream/state")
        assert response["Content-Type"] == "application/json"

    def test_stream_state_response_structure(self, admin_client):
    ...
    def test_stream_state_default_values(self, admin_client):
    ...
    def test_stream_state_input_main_connected_true(self, admin_client):
    ...
    def test_stream_state_input_main_streaming_true(self, admin_client):
    ...
    def test_stream_state_input_show_connected_true(self, admin_client):
    ...
    def test_stream_state_input_show_streaming_true(self, admin_client):
    ...
    def test_stream_state_schedule_streaming_true(self, admin_client):
    ...
    def test_stream_state_all_connected(self, admin_client):
    ...
    def test_stream_state_mixed_states(self, admin_client):
    ...
    def test_stream_state_data_types(self, admin_client):
    ...
    def test_stream_state_post_not_allowed(self, admin_client):
    ...
    def test_stream_state_put_not_allowed(self, admin_client):
    ...
    def test_stream_state_patch_not_allowed(self, admin_client):
    ...
    def test_stream_state_delete_not_allowed(self, admin_client):
        """DELETE should not be allowed on StreamState endpoint."""
        response = admin_client.delete("/api/v2/stream/state")
        assert response.status_code == 405

    def test_stream_state_user_preferences_ignored(self, admin_client):
    ...
    def test_stream_state_site_pref_takes_precedence(self, admin_client):
    ...
    def test_stream_state_invalid_values_treated_as_false(self, admin_client):
