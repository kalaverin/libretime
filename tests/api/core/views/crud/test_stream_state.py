...
class TestStreamStateView:
    ...
    def test_stream_state_endpoint_available_with_api_key(self, guest_client):
        """StreamState endpoint should be accessible with API key."""
        response = guest_client.get("/api/v2/stream/state")
        assert response.status_code == 200

    def test_stream_state_returns_json(self, guest_client):
        """StreamState endpoint should return JSON."""
        response = guest_client.get("/api/v2/stream/state")
        assert response["Content-Type"] == "application/json"

    def test_stream_state_response_structure(self, guest_client):
    ...
    def test_stream_state_default_values(self, guest_client):
    ...
    def test_stream_state_input_main_connected_true(self, guest_client):
    ...
    def test_stream_state_input_main_streaming_true(self, guest_client):
    ...
    def test_stream_state_input_show_connected_true(self, guest_client):
    ...
    def test_stream_state_input_show_streaming_true(self, guest_client):
    ...
    def test_stream_state_schedule_streaming_true(self, guest_client):
    ...
    def test_stream_state_all_connected(self, guest_client):
    ...
    def test_stream_state_mixed_states(self, guest_client):
    ...
    def test_stream_state_data_types(self, guest_client):
    ...
    def test_stream_state_post_not_allowed(self, guest_client):
    ...
    def test_stream_state_put_not_allowed(self, guest_client):
    ...
    def test_stream_state_patch_not_allowed(self, guest_client):
    ...
    def test_stream_state_delete_not_allowed(self, guest_client):
        """DELETE should not be allowed on StreamState endpoint."""
        response = guest_client.delete("/api/v2/stream/state")
        assert response.status_code == 405

    def test_stream_state_user_preferences_ignored(self, guest_client):
    ...
    def test_stream_state_site_pref_takes_precedence(self, guest_client):
    ...
    def test_stream_state_invalid_values_treated_as_false(self, guest_client):
