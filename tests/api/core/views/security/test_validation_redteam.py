...
class TestNegativeValueValidation:
    ...
    def test_smartblock_content_negative_offset_rejected(
        ...
        assert (
            "offset" in str(response.data)
            or "non-negative" in str(response.data).lower()
        )

    def test_smartblock_criteria_negative_group_rejected(
        self, host_client, host_user, faker,
    ):
        ...
        assert (
            "group" in str(response.data)
            or "negative" in str(response.data).lower()
        )

    def test_playlist_content_negative_position_rejected(
        self, host_client, host_user, faker,
    ):
        ...
        assert (
            "position" in str(response.data)
            or "negative" in str(response.data).lower()
        )

    def test_file_negative_channels_rejected(
        self, host_client, host_user, faker,
    ):
...
class TestTimeValidation:
    ...
    def test_smartblock_content_invalid_time_format_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_smartblock_content_cue_out_before_cue_in_rejected(
        self, host_client, host_user, faker,
    ):
        ...
        assert (
            "cue_out" in str(response.data).lower()
            or "after" in str(response.data).lower()
        )

    def test_playlist_invalid_length_format_rejected(
        self, host_client, host_user, faker,
    ):
...
class TestColorValidation:
    ...
    def test_show_invalid_color_format_rejected(
        ...
        assert (
            "color" in str(response.data).lower()
            or "hex" in str(response.data).lower()
        )

    def test_show_short_color_rejected(
        self, manager_client, manager_user, faker,
    ):
    ...
    def test_show_color_with_hash_accepted(
        self, manager_client, manager_user, faker,
    ):
...
class TestChoiceValidation:
    ...
    def test_smartblock_invalid_kind_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_smartblock_criteria_invalid_criteria_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_smartblock_criteria_invalid_condition_rejected(
        self, host_client, host_user, faker,
    ):
...
class TestRequiredFieldValidation:
    ...
    def test_smartblock_empty_name_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_smartblock_whitespace_name_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_showdays_negative_duration_rejected(
        self, manager_client, manager_user, faker,
    ):
        ...
        response = manager_client.post(
            "/api/v2/show-days", data, format="json",
        )
        ...
        assert (
            "duration" in str(response.data).lower()
            or "negative" in str(response.data).lower()
        )
...
class TestLengthOverflowValidation:
    ...
    def test_webstream_url_too_long_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_webstream_name_too_long_rejected(
        self, host_client, host_user, faker,
    ):
    ...
    def test_smartblock_criteria_value_too_long_rejected(
        self, host_client, host_user, faker,
    ):
...
class TestEdgeCaseValidation:
    ...
    def test_zero_values_accepted(self, host_client, host_user, faker):
        ...
        assert (
            response.status_code == 201
        ), f"Zero offset should be accepted, got {response.status_code}"
    ...
    def test_boundary_time_values(self, host_client, host_user, faker):
        ...
        assert (
            response.status_code == 400
        ), "cue_out == cue_in should be rejected"
