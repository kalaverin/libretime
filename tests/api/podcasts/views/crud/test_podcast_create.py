...
class TestPodcastViewSetCreate:
    ...
    def test_create_podcast_success(self, admin_client):
    ...
    def test_create_minimal_podcast_success(self, admin_client):
    ...
    def test_create_missing_url_fails(self, admin_client):
    ...
    def test_create_missing_title_fails(self, admin_client):
    ...
    def test_create_duplicate_url_allowed(self, admin_client):
    ...
    def test_create_no_auth_fails(self, admin_client):
    ...
    def test_create_unicode_fields(self, admin_client):
    ...
    def test_create_long_url(self, admin_client):
